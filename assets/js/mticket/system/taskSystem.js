var TaskSystem = (function () {
    ...
    TaskSystem.prototype._debug_ = function()
    {
      ...
      this.__tasks.push(new Task(new Vector2f(50,140), new Vector2f(300,30), "Je ne trouve plus l'icone Google", "Plusieurs versions sont apparues avec le temps, parfois par accident, souvent intentionnellement (histoire d'y rajouter de petits clins d'oeil, voire des phrases embarassantes).", "D009", "11/05/18", Status.UNDEFINED, "Vincent RISOTO"));
      this.__tasks.push(new Task(new Vector2f(50,180), new Vector2f(300,30), "Ça va ?", "Contrairement à une opinion répandue, le Lorem Ipsum n'est pas simplement du texte aléatoire.", "D111", "04/12/18", Status.UNTREATED, "Bernard GROSS"));
    };
    ////////DEBUG////////
