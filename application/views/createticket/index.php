<div id="form_container">
	...
	<form id="createticket" class="form" method="post" action="<?php echo base_url();?>controllers/createTicket">
		<div class="form_item">
    ...
    <div class="form_item">
      <textarea class="form_textarea_large_style" name="ticket_details" placeholder="Votre description..." rows="8" cols="45"></textarea>
    </div>
    <div id="form_submit">
